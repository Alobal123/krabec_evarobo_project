...
class Robot:
    ...
    GENOME_LENGTH = (SENSORS*HIDDEN+HIDDEN*MOTORS)*LEGS + 1*HIDDEN
    ...
    def build(self):
        ...
        vestibular = self.simulator.send_vestibular_sensor(body_id=main_body)
        ...
        hip_sensors = [0]*4
        knee_sensors = [0]*4
        sensor_neurons = [0]*(SENSORS*LEGS + 1)
        motor_neurons = [0]*8
        hidden_neurons = []
        ...
        WeightIndex = 0
        sensor_neurons[-1] = self.simulator.send_sensor_neuron(vestibular)
